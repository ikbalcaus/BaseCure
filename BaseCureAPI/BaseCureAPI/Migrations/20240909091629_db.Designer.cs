...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseCureAPI.DB.Models.Korisnici", b =>
                {
                    ...
                    b.Property<string>("KonekcijskiId")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)")
            ...
            modelBuilder.Entity("BaseCureAPI.DB.Models.Poruke", b =>
                {
                    ...
                    b.Property<int>("PosiljaocId")
                        .HasColumnType("int")
                        .HasColumnName("posiljaoc_id");

                    b.Property<int>("PrimaocId")
                        .HasColumnType("int")
                        .HasColumnName("primaoc_id");

                    b.Property<bool>("Procitana")
                        .HasColumnType("bit")
                        .HasColumnName("procitana");
            ...
            modelBuilder.Entity("BaseCureAPI.DB.Models.Poruke", b =>
                {
                    b.HasOne("BaseCureAPI.DB.Models.Korisnici", "Posiljaoc")
                        .WithMany("PorukePosiljaocs")
                        .HasForeignKey("PosiljaocId")
                        .IsRequired()
                        .HasConstraintName("FK__Poruke__Posiljao__308E3499");

                    b.HasOne("BaseCureAPI.DB.Models.Korisnici", "Primaoc")
                        .WithMany("PorukePrimaocs")
            ...
            modelBuilder.Entity("BaseCureAPI.DB.Models.Korisnici", b =>
                {
                    ...
                    b.Navigation("PorukePosiljaocs");

                    b.Navigation("PorukePrimaocs");
                });
