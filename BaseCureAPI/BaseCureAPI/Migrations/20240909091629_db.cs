        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    broj_telefona = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    konekcijski_id = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Ljekari__korisni__1B9317B3",
                        column: x => x.korisnik_id,
                        principalTable: "Korisnici",
                        principalColumn: "korisnik_id");
                    table.ForeignKey(
                        name: "FK__Ljekari__ustanov__1A9EF37A",
                        column: x => x.ustanova_id,
                        principalTable: "UstanoveZdravstva",
                        principalColumn: "ustanova_id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    datum_vrijeme = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Poruke__9D276F6D10459F44", x => x.poruka_id);
                    table.ForeignKey(
                        name: "FK__Poruke__Posiljao__308E3499",
                        column: x => x.posiljaoc_id,
                        principalTable: "Korisnici",
                        principalColumn: "korisnik_id");
                    table.ForeignKey(
                        name: "FK__Poruke__PrimaocI__318258D2",
