...
@Component({
  ...
  templateUrl: './doctor-patient-prescription.component.html',
  styleUrl: './doctor-patient-prescription.component.css',
})
export class DoctorPatientPrescriptionComponent {
  patients: any;
...
@NgModule({
  declarations: [
    DoctorPatientPrescriptionComponent,
